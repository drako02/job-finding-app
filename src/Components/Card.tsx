...
export const Card = ({candidate,employer,mentor,trainer, soon, onClick, id, active}:CardProps) => {
    ...
    return(
        <div onClick={handleClick}
             className={` ${active? "bg-[#F5F5F5] border-[1px] border-[#818181]" : ""}  ${soon? "cursor-not-allowed opacity-50": "cursor-pointer"} relative h-[21.2%] w-[100%] flex flex-col justify-evenly items- px-[24px] border border-[#E8E8E8] rounded-[2px] active:bg-[#F5F5F5] active:border-[1px] active:border-[#818181]`}>
            { soon && <div
            ...
            <div className={`w-[85.4%] h-[72px] font-bold leading-[150%] flex flex-col justify-start gap-[8px] ${soon? "text-[#818181]":"text-black"}`}>
